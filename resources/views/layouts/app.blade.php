...
<body>
    ...
    <div id="app">
        ...
        <div class="page-wrapper chiller-theme toggled" style="background-color: #b8b596;">
            {{-- @yield('content-factura')
                @hasSection('content-producto') --}}
            <div class="container-fluid " style="background-color: #b8b596; margin-top:30px; min-height:100%;">
